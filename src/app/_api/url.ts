export class APIUrls {
  public static readonly BASE_URL = 'http://localhost:3600';
	...
	//ADMIN
  	...
  	public static readonly ADMIN_SIGNUP = `${APIUrls.ADMIN_BASE_URL}/signup`; //WONTFIX
	...
	public static readonly ADMIN_VIEW_STAFF_ADVISOR = `${APIUrls.ADMIN_BASE_URL}/viewStaffAdvisor`; //DONE
	public static readonly ADMIN_SHOW_CLASSES = `${APIUrls.ADMIN_BASE_URL}/showClasses`; //DONE

	public static readonly ADMIN_DELETE_CLASS = `${APIUrls.ADMIN_BASE_URL}/deleteClass`; //LATER
	...
	public static readonly STAFF_GIVE_ASSIGNMENT = `${APIUrls.STAFF_BASE_URL}/giveAssignment`;  //DONE
	...
	public static readonly STAFF_CHANGE_PASSWORD = `${APIUrls.STAFF_BASE_URL}/changePassword`; //LATER
	...
	public static readonly STUDENT_CHANGE_PASSWORD = `${APIUrls.STUDENT_BASE_URL}/changePassword`; //LATER
